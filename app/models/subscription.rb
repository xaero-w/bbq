...
class Subscription < ActiveRecord::Base
  ...
  def existing_user
    # пока жи сообщение об ошике если поьзователь с хочет подписаться на свое же событие (идет проверка почты того
    # кто создал события с тем кто хочет на него подписаться)
